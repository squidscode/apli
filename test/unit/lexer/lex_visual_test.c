...
int main() {
    ...
    token_rules_add_rule_offset(token_rules, f_include, 0, 0, "<[a-zA-Z_.]+>");
    ...
    token_rules_add_rule_offset(token_rules, type, 1, 1, "[^a-zA-Z_]const (size_t|void|char|int)[^a-zA-Z_]");
    token_rules_add_rule_offset(token_rules, type, 1, 1, "[^a-zA-Z_](size_t|void|char|int)[^a-zA-Z_]");
    ...
    token_rules_add_rule_offset(token_rules, operator, 0, 0, "(=|<|>|.|\\+|-)");
    token_rules_add_rule_offset(token_rules, fn_identifier, 1, 1, "[^#a-zA-Z_][#a-zA-Z_]+[ ]*\\(");
    token_rules_add_rule_offset(token_rules, identifier, 1, 1, "[^#a-zA-Z_][#a-zA-Z_]+[^#a-zA-Z_]");
#else
    token_rules_add_rule_offset(token_rules, comment, 0, 0, "//[^\n]*|/\\*([^*]|\\*[^/])*\\*/");
    token_rules_add_rule_offset(token_rules, string_literal, 0, 0, "\"([^\n\"]|\\\")*\"");
    token_rules_add_rule_offset(token_rules, f_include, 0, 0, "<[a-zA-Z_.]+>");
    token_rules_add_rule_offset(token_rules, character, 0, 0, "'\\\\?[^]'");
    token_rules_add_rule_offset(token_rules, semicolon, 0, 0, ";");
    token_rules_add_rule_offset(token_rules, open_brace, 0, 0, "\\{");
    ...
    token_rules_add_rule_offset(token_rules, open_brack, 0, 0, "\\[");
    token_rules_add_rule_offset(token_rules, close_brack, 0, 0, "\\]");
    token_rules_add_rule_offset(token_rules, type, 0, 0, "(const )?(size_t|void|char|int)");
    token_rules_add_rule_offset(token_rules, keyword, 0, 0, "(while|for|return|#include|#define|#ifndef|#endif|#ifdef|typedef|if|else|break|continue)");
    token_rules_add_rule_offset(token_rules, operator, 0, 0, "(==|!=|<=|>=|->|\\+=|-=|\\+\\+|--|&&|<<|>>|=|<|>|.|\\+|-)");
    token_rules_add_rule_offset(token_rules, special_operators, 0, 0, "(\\*|&)");
    token_rules_add_rule_offset(token_rules, number, 0, 0, "([123456789][0123456789]*|0)");
    token_rules_add_rule_offset(token_rules, fn_identifier, 0, 1, "[a-zA-Z_]+[ ]*\\(");
    token_rules_add_rule_offset(token_rules, identifier, 0, 0, "[a-zA-Z_]+");
#endif
